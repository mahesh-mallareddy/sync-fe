...
import { addCategorySchema } from "@/schema/admin/addcategory";
    ...
    return (
        <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mt-4 flex md:mt-0 md:ml-4">
                ...
                >
                    <Sheet >
                        <SheetTrigger>+ Add New Category </SheetTrigger>
                        <SheetContent className="overflow-y-auto" onClose={handleClose}>
                        <BasicForm formSchema={addCategorySchema} onSubmit={onSubmit} />
                        </SheetContent>
                    </Sheet>
                </button>
            </div>
